...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            echo '<li class="text-center"><a href="TV.php?t=',  $row['ID'] ,'" class="color-black pagination-img-size name-font-size"><img title="', $row['tv_name'] , ' (' , $row['tv_year'] , ') " src="images/tv-poster/', $row['poster'] , '" alt="Poster of', $row['tv_name'] ,'"></a></li>';
        }
